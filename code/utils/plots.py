...
def get_surface_trace(points,decoder,latent,resolution,mc_value,is_uniform,verbose,save_ply, connected=False):
    ...
    if (not (np.min(z) > mc_value or np.max(z) < mc_value)):
        ...
        # dxy
        # https://github.com/scikit-image/scikit-image/blob/main/doc/release/release_0.19.rst:
        # The deprecated skimage.measure.marching_cubes_lewiner function has been removed
